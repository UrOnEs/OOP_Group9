...
/**
 * @brief Worker unit capable of gathering resources and constructing buildings.
 */
...
private:
    ...
    std::weak_ptr<Building> targetConstruction;
...
public:
    ...
    /**
     * @brief Main update loop for Villager logic (State machine).
     */
    ...
    void startBuilding(std::shared_ptr<Building> building);
