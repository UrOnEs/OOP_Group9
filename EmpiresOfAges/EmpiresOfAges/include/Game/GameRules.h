...
/**
 * @brief Global game constants and balancing parameters.
 */
namespace GameRules {
    ...
    constexpr Cost getBuildingCost(BuildTypes type) {
        ...
        case BuildTypes::TownCenter: return { 400, 0, 0, 200 };
    ...
    constexpr float HP_Stone = 500.f;
    constexpr float HP_Gold = 300.f;
    ...
    // --- Fog of War Ranges ---
    constexpr float Range_Sight_Unit = 250.f;
    constexpr float Range_Sight_Building = 350.f;
    constexpr float Range_Sight_TownCenter = 600.f;
    ...
    const sf::Vector2f Size_Farm = sf::Vector2f(128.f, 128.f);
    const sf::Vector2f Size_TownCenter = sf::Vector2f(192.f, 192.f);

    constexpr int Resources_Per_Tree = 500;
    constexpr int Resources_Per_Stone = 300;
    constexpr int Resources_Per_Gold = 500;
    constexpr int Wood_Per_Tick = 10;
    constexpr int Stone_Per_Tick = 10;
    constexpr int Gold_Per_Tick = 10;
